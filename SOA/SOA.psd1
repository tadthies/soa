...
Description = 'The preqrequisites installation scripts for Microsoft security assessments'
...
NestedModules = @('SOA-Prerequisites.psm1', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Microsoft','Security','Assessment','M365'

        # A URL to the license for this module.
        # LicenseUri = ''

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/o365soa/soa/'
